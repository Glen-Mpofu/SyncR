    ...
    public SyncRUI() {
       ...
       // Main panel with BorderLayout
        ...
        JPanel locationsPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 10));
            ...
            locationsPanel.setBackground(new Color(0xFFE566));
        ...
        bottomPanel.setBackground(new Color(0xFFE566));
        ...
        JPanel middlePnl = new JPanel(new BorderLayout());
            ...
            copyParamPnl.setBackground(new Color(0xFFE566));
        ...
        JPanel buttonPanel = new JPanel(new BorderLayout());
            ...
            buttonPanel.setBackground(new Color(0xFFE566));
        ...
        topPnl.setBackground(new Color(0xFFE566));
        middlePnl.setBackground(new Color(0xFFE566));
        
        //Styling
        
        //Styling the buttons
        
        Border  border=new BorderUIResource.BevelBorderUIResource(1, Color.black, Color.blue);
